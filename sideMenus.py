...
class Item:
    ...
    def display_bar(self,surface,value,max_value,selected):
        ...
        relativity_num = (value/max_value * full_height)
        val_rect = pygame.Rect(top[0] - 15 , bottom[1] - relativity_num, 30, 10)

        #draw
        pygame.draw.line(surface,colour,top,bottom,10)
        pygame.draw.rect(surface, colour, val_rect)
    ...
    def display(self,surface,selection_num,name,value,max_val,cost):
        ...
        self.display_bar(surface,value,max_val,self.index == selection_num)